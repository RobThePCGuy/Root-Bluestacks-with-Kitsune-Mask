...
> [!IMPORTANT]
> **Getting "Android system doesn't meet security" popup?** Check out [Troubleshooting](https://github.com/RobThePCGuy/Root-Bluestacks-with-Kitsune-Mask/master/README.md#troubleshooting).
